...
if ( $home_portfolio_query->posts ) :
    ...
    <div id="home-projects" class="home-projects-carousel clearfix">
        ...
        <?php $home_portfolio_title = wpex_get_data('home_portfolio_title') ? wpex_get_data('home_portfolio_title') : __('Recent Work','wpex'); ?>
        
		<?php if ( wpex_get_data('home_portfolio_title') !== 'disable') { ?>
            <div class="heading">
                <h2>
                <?php if( wpex_get_data('home_portfolio_title_url') ) { ?>
                    <a href="<?php echo wpex_get_data('home_portfolio_title_url'); ?>" title="<?php echo $wpex_portfolio_title; ?>">
                <?php } ?>
            ...
            <div id="home-portfolio-carousel" class="fredcarousel">
                ...
                if( has_post_thumbnail() ) :  ?>
                    <div class="portfolio-item count-<?php echo $count; ?>">
                        <a href="<?php the_permalink(); ?>" title="<?php the_title(); ?>"><img src="<?php echo aq_resize( wp_get_attachment_url( get_post_thumbnail_id() ), wpex_img('portfolio_carousel_entry_width'),  wpex_img('portfolio_carousel_entry_height'),  wpex_img('portfolio_carousel_entry_crop') ); ?>" alt="<?php echo the_title(); ?>" /></a>
                        <h3><?php the_title(); ?></h3>
                    </div><!-- /portfolio-item -->
                <?php endif; ?>
