...
<div id="home-static-page" class="clearfix">
	...
	<?php $home_static_page_title = wpex_get_data('home_static_page_title') ? wpex_get_data('home_static_page_title') : __('What We Do','wpex'); ?>
        
	<?php if ( wpex_get_data('home_static_page_title') !== 'disable') { ?>
        <div class="heading">
            <h2>
            <?php if( wpex_get_data('home_static_page_title_url') ) { ?>
                <a href="<?php echo wpex_get_data('home_static_page_title_url'); ?>" title="<?php echo $wpex_static_page_title; ?>">
            <?php } ?>
