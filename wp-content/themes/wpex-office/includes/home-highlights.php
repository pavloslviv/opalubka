...
if( $home_highlights_query->posts ) : ?>
    ...
    <div id="home-highlights" class="clearfix">
        ...
        <?php $home_highlights_title = wpex_get_data('home_highlights_title') ? wpex_get_data('home_highlights_title') : __('What We Do','wpex'); ?>
        
		<?php if ( wpex_get_data('home_highlights_title') !== 'disable') { ?>
            <div class="heading">
                <h2>
                <?php if( wpex_get_data('home_highlights_title_url') ) { ?>
                    <a href="<?php echo wpex_get_data('home_highlights_title_url'); ?>" title="<?php echo $wpex_highlights_title; ?>">
                <?php } ?>
        ...
        <div class="hp-highlight count-<?php echo $count; ?>">
        	<?php if( get_post_meta(get_the_ID(), 'office_hp_highlights_url', TRUE) !== '' ) { ?>
            	<a href="<?php echo get_post_meta(get_the_ID(), 'office_hp_highlights_url', TRUE); ?>" title="<?php the_title(); ?>" target="_<?php echo $hp_highlights_url_target; ?>" class="hp-highlight-link">
            <?php } ?>
