...
<div id="home-blog" class="clearfix">
	...
	<?php $home_blog_title = wpex_get_data('home_blog_title') ? wpex_get_data('home_blog_title') : __('Recent Posts','wpex'); ?>
        
		<?php if ( wpex_get_data('home_blog_title') !== 'disable') { ?>
            <div class="heading">
                <h2>
                <?php if( wpex_get_data('home_blog_title_url') ) { ?>
                    <a href="<?php echo wpex_get_data('home_blog_title_url'); ?>" title="<?php echo $wpex_blog_title; ?>">
                <?php } ?>
    ...
    <?php $count++; ?>
        ...
        <div class="home-entry count-<?php echo $count; ?>">
            <?php if( has_post_thumbnail() ) { ?>
                <a href="<?php the_permalink(); ?>" title="<?php the_title(); ?>"><img src="<?php echo aq_resize( wp_get_attachment_url( get_post_thumbnail_id() ), wpex_img('home_blog_entry_width'),  wpex_img('home_blog_entry_height'),  wpex_img('home_blog_entry_crop') ); ?>" alt="<?php echo the_title(); ?>" /></a>
            <?php } ?>
