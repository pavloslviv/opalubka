...
if ( wpex_get_data('home_tagline') ) : ?>
	...
	<?php $wpex_tagline_title = wpex_get_data('home_tagline_title') ? wpex_get_data('home_tagline_title') : __('Welcome','wpex'); ?>
    
    <?php if ( wpex_get_data('home_tagline_title') !== 'disable') { ?>
        <div class="heading">
            <h2>
            <?php if( wpex_get_data('home_tagline_title_url') ) { ?>
                <a href="<?php echo wpex_get_data('home_tagline_title_url'); ?>" title="<?php echo $wpex_tagline_title; ?>">
            <?php } ?>
