                ...
                <?php while ( $home_flexslides_query->have_posts() ) : $home_flexslides_query->the_post(); ?>    
                    ...
                    <?php else : ?>
						<?php if( has_post_thumbnail() ) : ?>
                            <li class="slide">
                                <?php if( get_post_meta(get_the_ID(), 'office_slides_url', TRUE) !== '' ) { ?><a href="<?php echo get_post_meta(get_the_ID(), 'office_slides_url', TRUE); ?>" title="<?php the_title(); ?>" target="_<?php echo get_post_meta(get_the_ID(), 'office_slides_url_target', TRUE); ?>"><?php } ?> 
                                	<img src="<?php echo aq_resize( wp_get_attachment_url( get_post_thumbnail_id() ), wpex_img('home_slider_width'),  wpex_img('home_slider_height'),  wpex_img('home_slider_crop') ); ?>" alt="<?php echo the_title(); ?>" />
