        ...
        <div id="full-slides" class="flexslider clearfix">
            <ul class="slides">
                <?php foreach ($attachments as $attachment) : ?>
					<li class="slide">
						<img src="<?php echo aq_resize( wp_get_attachment_url( $attachment->ID ), wpex_img('page_slider_width'),  wpex_img('page_slider_height'),  wpex_img('page_slider_crop') ); ?>" alt="<?php echo apply_filters('the_title', $attachment->post_title); ?>" />
