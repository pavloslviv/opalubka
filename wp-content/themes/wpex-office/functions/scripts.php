...
function wpex_load_scripts() {
	...
	*******************/
	...
	if( wpex_get_data('disable_responsive','1') == '1' ) {
		...
		$nav_params = array( 'text' => wpex_get_data('responsive_menu_text', __('Go to...','wpex') ) );
	...
	if(is_page_template('template-portfolio-with-filter.php')) {
		wp_enqueue_script('isotope',  WPEX_JS_DIR_URI .'isotope.js', array('jquery'), '1.5.19', true);
	...
	if(is_page_template('template-faqs.php')) {
		wp_enqueue_script('office-faqs', WPEX_JS_DIR_URI .'faqs.js', array('jquery'), '1.0', true);
		wp_enqueue_script('quicksand', WPEX_JS_DIR_URI .'quicksand.js', array('jquery'), '1.2.2', true);
		wp_enqueue_script('easing', WPEX_JS_DIR_URI .'easing.js', array('jquery'), '1.3', true);
		wp_enqueue_script('office-quicksandinit', WPEX_JS_DIR_URI .'quicksand-faqs.js', array('jquery','quicksand','easing'), '1.0', true);
	}
...
if ( !function_exists('wpex_ie_css') ) {
	...
	function wpex_ie_css() {
		echo ' <!--[if IE]><script src="http://html5shiv.googlecode.com/svn/trunk/html5.js"></script><![endif]-->';
...
* @Since 1.0
*/
if( wpex_get_data('retina_logo') && wpex_get_data('retina_logo_height') && wpex_get_data('retina_logo_width') ) {	
