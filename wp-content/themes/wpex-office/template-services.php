	...
	if ( $services_posts->posts ) : ?>
        ...
        <div id="services-wrap" class="clearfix">
            ...
            <ul id="service-tabs">
                ...
                <li>
                    <a href="#tab-<?php echo( basename(get_permalink() ) ); ?>" title="<?php the_title(); ?>">
						<?php if( has_post_thumbnail() ) { ?>
                            <span><img src="<?php echo wp_get_attachment_url( get_post_thumbnail_id() ); ?>" alt="<?php the_title(); ?>" /></span>
                        <?php } ?>
                        <?php the_title(); ?>
                    </a>
                </li>
