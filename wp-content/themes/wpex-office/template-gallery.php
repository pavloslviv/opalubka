        ...
        <article class="gallery-wrap clearfix">
                ...
                <?php foreach( $wp_query->posts as $post ) : setup_postdata( $post ); ?>
                    <div class="gallery-photo">
                        <a href="<?php echo wp_get_attachment_url( get_the_ID() ); ?>" class="single-gallery-thumb" rel="prettyPhoto[gallery]" title="<?php the_title(); ?>">
                            <img src="<?php echo aq_resize( wp_get_attachment_url( get_the_ID() ),  wpex_img( 'gallery_template_width' ), wpex_img( 'gallery_template_height' ), wpex_img( 'gallery_template_crop' ) ); ?>" alt="<?php the_title(); ?>" class="attachment-post-thumbnail" height="" />
                        </a>
                    </div><!-- /gallery-photo -->
                <?php endforeach; ?>
